...
const translations: Translations = {
  en: {
    ...
    redeem_placeholder: 'Enter your code here',
    redeem_button: 'Redeem Now',
    redeem_success: 'Code redeemed successfully!',
    redeem_error: 'Invalid or used code.',
  ...
  tl: {
    ...
    redeem_code: 'I-redeem ang Code',
    redeem_placeholder: 'Ilagay ang iyong code dito',
    redeem_button: 'I-redeem Na',
    redeem_success: 'Matagumpay na na-redeem ang code!',
    redeem_error: 'Di-wasto o nagamit na ang code.',
    most_viewed: 'Pinakapinanood',
    most_rated: 'Pinakamataas ang Rate',
  },
};
